...
class Model_Finder:
    ...
    def get_best_params_for_random_forest(self,train_x,train_y):
        ...
        try:
            ...
            self.max_depth = None    #self.grid.best_params_['max_depth']
            self.max_features = 'auto' #self.grid.best_params_['max_features']
            self.n_estimators = 10    #self.grid.best_params_['n_estimators']
