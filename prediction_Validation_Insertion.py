...
import Prediction_Raw_Data_Validation.predictionDataValidation
...
class pred_validation:
    def __init__(self,path):
        self.raw_data = Prediction_Raw_Data_Validation.predictionDataValidation.Prediction_Data_validation(path)
